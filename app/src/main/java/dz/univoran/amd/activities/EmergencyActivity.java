...
import dz.univoran.amd.widget.WidgetProvider;
...
public class EmergencyActivity extends AppCompatActivity {
    ...
    public void phone(View view) {
        ...
        if (android.support.v4.app.ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
